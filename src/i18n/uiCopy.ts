...
const uiCopy = {
  en: {
    ...
    restaurant: {
      ...
      chatPlaceholder: "Ask about {name}...",
      chatGuide: "AI guide for {name} — Ask me anything about this restaurant!",
      signatureDish: "What's the signature dish at {name}?",
  ...
  ja: {
    ...
    restaurant: {
      ...
      chatPlaceholder: "{name}について質問...",
      chatGuide: "{name}のAIガイドです。このレストランについて何でも聞いてください！",
      signatureDish: "{name}の看板料理は何ですか？",
  ...
  ko: {
    ...
    restaurant: {
      ...
      chatPlaceholder: "{name}에 대해 질문하세요...",
      chatGuide: "{name}의 AI 가이드입니다. 이 레스토랑에 대해 무엇이든 물어보세요!",
      signatureDish: "{name}의 대표 요리는 무엇인가요?",
  ...
  "zh-Hans": {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "询问{name}...",
      chatGuide: "{name}的AI向导，随时询问关于这家餐厅的任何问题！",
      signatureDish: "{name}的招牌菜是什么？",
  ...
  "zh-Hant": {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "詢問{name}...",
      chatGuide: "{name}的AI導覽，隨時詢問關於這家餐廳的任何問題！",
      signatureDish: "{name}的招牌菜是什麼？",
  ...
  es: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Pregunta sobre {name}...",
      chatGuide: "Guía de IA para {name} — ¡Pregúntame cualquier cosa sobre este restaurante!",
      signatureDish: "¿Cuál es el plato estrella de {name}?",
  ...
  fr: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Demandez sur {name}...",
      chatGuide: "Guide IA pour {name} — Demandez-moi n'importe quoi sur ce restaurant !",
      signatureDish: "Quel est le plat signature de {name} ?",
  ...
  de: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Frag über {name}...",
      chatGuide: "KI-Guide für {name} — Frag mich alles über dieses Restaurant!",
      signatureDish: "Was ist das Signature-Gericht von {name}?",
  ...
  it: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Chiedi su {name}...",
      chatGuide: "Guida AI per {name} — Chiedimi qualsiasi cosa su questo ristorante!",
      signatureDish: "Qual è il piatto forte di {name}?",
      aboutCuisine: "Raccontami della cucina {cuisine}",
      bestTime: "Qual è il momento migliore per visitare {name}?",
      dietaryOptions: "Ci sono opzioni dietetiche disponibili?",
    },
  },
  pt: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Pergunte sobre {name}...",
      chatGuide: "Guia de IA para {name} — Pergunte-me qualquer coisa sobre este restaurante!",
      signatureDish: "Qual é o prato exclusivo de {name}?",
      aboutCuisine: "Conte-me sobre a culinária {cuisine}",
      bestTime: "Qual é o melhor momento para visitar {name}?",
      dietaryOptions: "Há opções dietéticas disponíveis?",
    },
  },
  ru: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Спросите о {name}...",
      chatGuide: "ИИ‑гид для {name} — Спрашивайте всё об этом ресторане!",
      signatureDish: "Какое фирменное блюдо в {name}?",
      aboutCuisine: "Расскажите о кухне {cuisine}",
      bestTime: "Когда лучше всего посетить {name}?",
      dietaryOptions: "Есть ли диетические варианты?",
    },
  },
  th: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "ถามเกี่ยวกับ {name}...",
      chatGuide: "ผู้ช่วย AI สำหรับ {name} — ถามอะไรก็ได้เกี่ยวกับร้านอาหารนี้!",
      signatureDish: "เมนูเด็ดของ {name} คืออะไร?",
      aboutCuisine: "บอกเกี่ยวกับอาหาร {cuisine}",
      bestTime: "ควรไปเยี่ยม {name} เมื่อไหร่ดี?",
      dietaryOptions: "มีตัวเลือกอาหารพิเศษไหม?",
    },
  },
  vi: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Hỏi về {name}...",
      chatGuide: "Hướng dẫn AI cho {name} — Hỏi tôi bất cứ điều gì về nhà hàng này!",
      signatureDish: "Món ăn đặc trưng của {name} là gì?",
      aboutCuisine: "Hãy cho biết về ẩm thực {cuisine}",
      bestTime: "Thời điểm tốt nhất để ghé thăm {name} là khi nào?",
      dietaryOptions: "Có lựa chọn chế độ ăn nào không?",
    },
  },
  id: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Tanya tentang {name}...",
      chatGuide: "Panduan AI untuk {name} — Tanyakan apa saja tentang restoran ini!",
      signatureDish: "Apa hidangan khas di {name}?",
      aboutCuisine: "Ceritakan tentang masakan {cuisine}",
      bestTime: "Kapan waktu terbaik mengunjungi {name}?",
      dietaryOptions: "Apakah ada pilihan diet?",
    },
  },
  ms: {
    common: {
    ...
    restaurant: {
      ...
      signatureDish: "Apakah hidangan istimewa di {name}?",
      aboutCuisine: "Beritahu saya tentang masakan {cuisine}",
      bestTime: "Bila masa terbaik untuk lawati {name}?",
      dietaryOptions: "Adakah pilihan pemakanan tersedia?",
    },
  },
  ar: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "اسأل عن {name}...",
      chatGuide: "دليل الذكاء الاصطناعي لـ {name} — اسألني أي شيء عن هذا المطعم!",
      signatureDish: "ما هو الطبق المميز في {name}؟",
      aboutCuisine: "أخبرني عن مطبخ {cuisine}",
      bestTime: "ما هو أفضل وقت لزيارة {name}؟",
      dietaryOptions: "هل تتوفر خيارات غذائية؟",
    },
  },
  hi: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "{name} के बारे में पूछें...",
      chatGuide: "{name} के लिए AI गाइड — इस रेस्तरां के बारे में कुछ भी पूछें!",
      signatureDish: "{name} की खास डिश क्या है?",
      aboutCuisine: "{cuisine} व्यंजन के बारे में बताएं",
      bestTime: "{name} जाने का सबसे अच्छा समय क्या है?",
      dietaryOptions: "क्या आहार विकल्प उपलब्ध हैं?",
    },
  },
  tr: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "{name} hakkında sorun...",
      chatGuide: "{name} için AI rehberi — Bu restoran hakkında bana her şeyi sorun!",
      signatureDish: "{name}'in özel yemeği nedir?",
      aboutCuisine: "{cuisine} mutfağı hakkında bilgi ver",
      bestTime: "{name}'i ziyaret etmek için en iyi zaman ne zaman?",
      dietaryOptions: "Diyet seçenekleri mevcut mu?",
    },
  },
  bn: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "{name} সম্পর্কে জিজ্ঞাসা করুন...",
      chatGuide: "{name} এর জন্য AI গাইড — এই রেস্তোরাঁ সম্পর্কে যে কোনো কিছু জিজ্ঞাসা করুন!",
      signatureDish: "{name} এর বিশেষ খাবার কী?",
      aboutCuisine: "{cuisine} রন্ধনপ্রণালী সম্পর্কে বলুন",
      bestTime: "{name} পরিদর্শনের সেরা সময় কখন?",
      dietaryOptions: "কোনো খাদ্যতালিকা বিকল্প আছে কি?",
    },
  },
  my: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "{name} အကြောင်းမေးပါ...",
      chatGuide: "{name} အတွက် AI လမ်းညွှန် — ဤစားသောက်ဆိုင်အကြောင်းမေးချင်တာမေးပါ!",
      signatureDish: "{name} ရဲ့ အထူးဟင်းလျာက ဘာလဲ?",
      aboutCuisine: "{cuisine} အစားအစာအကြောင်း ပြောပြပါ",
      bestTime: "{name} သွားရန် အကောင်းဆုံးအချိန်က ဘယ်တုန်းလဲ?",
      dietaryOptions: "အစားအသောက်ရွေးချယ်မှုရွေးစရာရှိသလား?",
    },
  },
  tl: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Magtanong tungkol sa {name}...",
      chatGuide: "Gabay na AI para sa {name} — Magtanong tungkol sa restaurant na ito!",
      signatureDish: "Ano ang signature dish ng {name}?",
      aboutCuisine: "Sabihin sa akin tungkol sa lutuing {cuisine}",
      bestTime: "Kailan ang pinakamahusay na oras para bumisita sa {name}?",
      dietaryOptions: "May available ba na dietary options?",
    },
  },
  lo: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "ຖາມກ່ຽວກັບ {name}...",
      chatGuide: "ຄູ່ມື AI ສຳລັບ {name} — ຖາມຫຍັງກໍໄດ້ກ່ຽວກັບຮ້ານອາຫານນີ້!",
      signatureDish: "ອາຫານພິເສດຂອງ {name} ແມ່ນຫຍັງ?",
      aboutCuisine: "ບອກກ່ຽວກັບອາຫານ {cuisine}",
      bestTime: "ເວລາທີ່ດີທີ່ສຸດທີ່ຈະໄປ {name} ແມ່ນເມື່ອໃດ?",
      dietaryOptions: "ມີທາງເລືອກອາຫານພິເສດບໍ່?",
    },
  },
  km: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "សួរអំពី {name}...",
      chatGuide: "មគ្គុទេសក៍ AI សម្រាប់ {name} — សួរអ្វីក៏បានអំពីភោជនីយដ្ឋាននេះ!",
      signatureDish: "តើមុខម្ហូបពិសេសនៅ {name} គឺជាអ្វី?",
      aboutCuisine: "ប្រាប់ខ្ញុំអំពីម្ហូប {cuisine}",
      bestTime: "តើពេលណាល្អបំផុតក្នុងការទស្សនា {name}?",
      dietaryOptions: "តើមានជម្រើសរបបអាហារទេ?",
    },
  },
  ne: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "{name} बारे सोध्नुहोस्...",
      chatGuide: "{name} को लागि AI गाइड — यो रेस्टुरेन्ट बारे जे पनि सोध्नुहोस्!",
      signatureDish: "{name} को विशेष परिकार के हो?",
      aboutCuisine: "{cuisine} खानाको बारेमा बताउनुहोस्",
      bestTime: "{name} जानको लागि उत्तम समय कहिले हो?",
      dietaryOptions: "के कुनै आहार विकल्पहरू उपलब्ध छन्?",
    },
  },
  mn: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "{name}-ийн талаар асуугаарай...",
      chatGuide: "{name}-ийн AI гарын авлага — Энэ ресторан дээр юу ч асуугаарай!",
      signatureDish: "{name}-ийн онцгой хоол юу вэ?",
      aboutCuisine: "{cuisine} хоолны тухай хэлнэ үү",
      bestTime: "{name} очихоор хамгийн сайн үе хэзээ вэ?",
      dietaryOptions: "Хоолны дэглэмийн сонголт байгаа юу?",
    },
  },
  fa: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "درباره {name} بپرسید...",
      chatGuide: "راهنمای هوش مصنوعی برای {name} — هر چیزی درباره این رستوران بپرسید!",
      signatureDish: "غذای ویژه {name} چیست؟",
      aboutCuisine: "درباره غذاهای {cuisine} بگویید",
      bestTime: "بهترین زمان برای بازدید از {name} چه زمانی است؟",
      dietaryOptions: "آیا گزینه‌های رژیم غذایی موجود است؟",
    },
  },
  uk: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Питайте про {name}...",
      chatGuide: "AI-гід для {name} — Питайте будь-що про цей ресторан!",
      signatureDish: "Яка фірмова страва в {name}?",
      aboutCuisine: "Розкажіть про кухню {cuisine}",
      bestTime: "Коли найкраще відвідати {name}?",
      dietaryOptions: "Чи є варіанти для дієт?",
    },
  },
  pl: {
    common: {
    ...
    restaurant: {
      ...
      continue: "Continue",
      noSelection: "Please select a restaurant",
      chatPlaceholder: "Pytaj o {name}...",
      chatGuide: "Przewodnik AI dla {name} — Pytaj o wszystko dotyczące tej restauracji!",
      signatureDish: "Jakie jest danie firmowe w {name}?",
      aboutCuisine: "Opowiedz mi o kuchni {cuisine}",
      bestTime: "Kiedy najlepiej odwiedzić {name}?",
      dietaryOptions: "Czy są dostępne opcje dietetyczne?",
    },
  },
} as const;
